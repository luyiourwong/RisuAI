export const languageEnglish = {
    ...
    help: {
        ...
        openRouterReasoningEffort: "Controls the reasoning resources used. This generates \"additional reasoning tokens\" beyond the main limit. For models that don't natively support effort (e.g., Claude or older Gemini), this value is *automatically* converted into an appropriate max_tokens request.\n\nExamples:\n• GPT-5 / 5.1 / o3 / o1: low, medium, high\n• GPT-5.2: Supports all levels\n• Gemini 3 Pro: low, high\n• Gemini 3 Flash: minimal, low, medium, high",
        openRouterReasoningMaxTokens: "Manually specifies the token limit for the reasoning process. This is an \"additional allowance\" and does not count against your main output limit. We recommend using 'Reasoning Effort' instead, since it will *automatic* conver max_tokens from the effort setting.\n\nSupported Models:\n• Gemini: 2.5 and earlier\n• Anthropic Claude series",
    ...
    openRouterReasoning: {
        ...
        note: "Choose one of Effort or Max Tokens, can not use both at the same time.",
        effortTitle: "Reasoning Effort",
        effortAuto: "Default",
        effortNone: "None",
        effortMinimal: "Minimal (10%)",
        effortLow: "Low (20%)",
        effortMedium: "Medium (50%)",
        effortHigh: "High (80%)",
        effortXhigh: "Very High (95%)",
        maxTokensTitle: "Max Reasoning Tokens (Leave blank for default)",
    },
