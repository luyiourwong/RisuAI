export const languageEnglish = {
    ...
    openRouterReasoning: {
        ...
        effortDescription: "Support by OpenAI, Grok, etc.",
        maxTitle: "Reasoning Max Tokens (Leave blank to use default)",
        maxDescription: "Support by Gemini, Anthropic, Qwen, etc.",
        exclude: "Exclude Reasoning Output",
